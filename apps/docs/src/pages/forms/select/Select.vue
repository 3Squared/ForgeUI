<template>
  <div>
    ...
    <p>
      ...
      <a class="link" target="_blank" href="https://bootstrap-vue.org/docs/components/form-select"><strong>Bootstrap Vue documentation</strong></a>
      .
    </p>
    <playground :options="options" :config="config" :code="code" @reset="reset">
      ...
      <template #options>
        ...
        <div class="d-flex mb-2">
          ...
          <b-button variant="primary" class="ml-2" @click="addOption">Add</b-button>
        </div>
      </template>
    </playground>
