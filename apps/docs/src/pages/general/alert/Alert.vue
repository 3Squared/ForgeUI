<template>
  <div>
    ...
    <p>
      ...
      <a class="link" href="https://bootstrap-vue.org/docs/components/alert" target="_blank">
        <strong>Bootstrap Vue documentation</strong>
      </a>
      .
    </p>
    <playground :code="code" :options="options" rerender :config="config" @reset="reset">
      <template #re-render>
      ...
      <template #dismissible>
        <b-form-checkbox v-model="options.dismissible" class="mb-2" @change="setDismissible">dismissible</b-form-checkbox>
      </template>
