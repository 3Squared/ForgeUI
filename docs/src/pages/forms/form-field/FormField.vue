<template>
  <div>
    ...
    <p>Further documentation and examples can be found in the <a class="link" target="_blank" href="https://saforgestyleguide.z33.web.core.windows.net/#/forms/form-field/formfield"><strong>Forge.UI documentation</strong></a>.</p>
    <OPTIONS />
    <playground :options="options" :code="code" :config="config" @reset="reset">
      ...
      <template #rules>
        <forge-form-field label="rules (vee-validate)" v-model="options.rules" type="text" />
      </template>
    </playground>
  </div>
</template>
