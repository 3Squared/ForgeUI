<template>
  <div>
    ...
    <p>Further documentation and examples can be found in the <a class='link' href='https://saforgestyleguide.z33.web.core.windows.net/#/forms/input/input' target='_blank'><strong>Forge.UI
