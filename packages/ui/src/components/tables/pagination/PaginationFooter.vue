<template>
  ...
  >
    <span class="input-group w-auto align-items-baseline" v-if="includePageSizeAndPageCount">
      <span class="input-group-prepend mr-2">Page Size:</span>
      <b-form-select :value="perPage" @input="$emit('update:perPage', $event)" :options="pageSizes" size="sm" />
    </span>
