    ...
    propsData: {
      getFileUrlAction: function onGetUrl() {
        return new Promise((resolve) => {
          ...
          setTimeout(() => {
            resolve(
              [`http://127.0.0.1:10000/devstoreaccount1/forgeui/${uploadFileName}?sv=2018-03-28&st=2022-01-05T13%3A14%3A50Z&se=2022-01-06T13%3A14%3A50Z&sr=c&sp=racwdl&sig=2ujYGm7gtHU5mfSVBRAQ7M8%2FK%2FxaZFTbpQZjb4pe5qU%3D`, uploadFileName]
            );
          }, 300);
        });
      },
